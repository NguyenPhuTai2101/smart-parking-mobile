    ...
    >
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerClassName="px-2">
        <View className="flex-row items-center justify-between mt-10 px-4">
          ...
          <Text className="flex-1 text-center text-xl font-semibold">Quên mật khẩu</Text>
        ...
        <View className="px-6 mt-6">
          <Text className="text-2xl font-semibold text-center">Bạn quên mật khẩu ?</Text>
          <Text className="text-center text-gray-600 mt-2">
            Đừng lo lắng! Bạn hãy nhập số điện thoại đã đăng ký tài khoản để nhận mã xác thực
          </Text>
        </View>
        ...
        <View className="px-6 mt-6">
          <Pressable
            onPress={onSend}
            className={`h-12 rounded-2xl items-center justify-center ${isValidPhone ? "bg-blue-600" : "bg-blue-400"}`}
          >
