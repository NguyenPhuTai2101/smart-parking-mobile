...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerClassName="px-6 py-10">
        <View className="flex-row items-center justify-between mt-1 px-4">
          <Text className="flex-1 text-center text-xl font-semibold">Đăng nhập</Text>
        </View>
        ...
        <Link href="/screens/auth/SendOTPScreen" className="text-blue-600 font-semibold self-end mb-4">
        ...
        <View className="items-center mt-1 mb-4">
          <Text className="text-gray-600">
            Chưa có tài khoản?{" "}
            <Link href="/screens/auth/SignUpScreen" className="text-blue-600 font-semibold">
              Đăng ký
            </Link>
          </Text>
        </View>
